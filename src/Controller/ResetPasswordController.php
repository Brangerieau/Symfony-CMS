...
use Brangerieau\SymfonyCmsBundle\Form\ChangePasswordFormType;
use Brangerieau\SymfonyCmsBundle\Form\ResetPasswordRequestFormType;
...
class ResetPasswordController extends AbstractController
{
    ...
    public function request(Request $request, MailerInterface $mailer, TranslatorInterface $translator): Response
    {
        ...
        return $this->render('@SymfonyCms/reset_password/request.html.twig', [
    ...
    public function checkEmail(): Response
    {
        ...
        return $this->render('@SymfonyCms/reset_password/check_email.html.twig', [
    ...
    public function reset(Request $request, UserPasswordHasherInterface $userPasswordHasher, TranslatorInterface $translator, string $token = null): Response
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            return $this->redirectToRoute('symfony_cms_login');
        }

        return $this->render('@SymfonyCms/reset_password/reset.html.twig', [
